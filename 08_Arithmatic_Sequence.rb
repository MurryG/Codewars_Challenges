...
# Instructions:
  ...
  # If f(n) = f(n-1) + c where c is a constant value, then f is an 
  # rithmetic sequence.
  # An example would be (where the first term is 0 and the constant
  #   is 1) is [0, 1, 2, 3, 4, 5, ... and so on] )
  ...
  # There are some sequences that aren't arithmetic nor are they
  # geometric.
  # Here is a link to feed your brain : Sequence !

  # You're going to write a function that's going to return the value
  # in the nth index of an arithmetic sequence.(That is, adding a
  # constant to move to the next element in the "set").

  # The function's name is nthterm/Nthterm, it takes three inputs
  # first,n,c where:
